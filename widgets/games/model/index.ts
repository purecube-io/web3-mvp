  ...
  games: [
    {
      ...
      description:
        'Chubby Runners is an adorable, silly, and simple-to-learn game combining mobile runner and battle royale genres. There is just you and a desire to outperform your fellow players. You need to survive, earn points, and race to the finish line round by round. Momentum really matters',
      genre: 'hybrid-casual',
      platform: 'mobile',
      developer: 'PureCube',
      status: 'beta',
...

    {
      ...
      title: 'Near Runner',
      description:
        'Near Runner is an animated, colorful, cartoonish game combining single-player and multiplayer modes. Test your skills against another player in an online match, climb to the top of the global leaderboard and show your friend and others who the boss is',
      genre: 'hybrid-casual',
      platform: 'mobile',
      developer: 'PureCube',
      status: 'demo',
