  ...
  return (
    <div className="flex flex-col justify-between gap-1 bg-neutral-800 p-2 md:p-3 rounded-3xl">
      <div className="flex flex-col">
        ...
        <span className="text-base md:text-lg uppercase font-heading-semibold">
          {teamMember.name}
        </span>
      ...
      <div className="flex gap-3">
        ...
        {teamMember.artstation && (
          <a href={teamMember.artstation} target="_blank" rel="noreferrer">
            <FontAwesomeIcon className="w-5" icon={faArtstation} />
          </a>
        )}
      </div>
    </div>
